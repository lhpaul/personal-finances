import DevSyncFixturesRoute from '../sync-fixtures';
...
describe('DevSyncFixturesRoute (implementation plan Decision 10, issue #11 — production gating)', () => {
  ...
  it('returns null when __DEV__ is false, without rendering anything or requiring the panel', () => {
    ...
    expect(DevSyncFixturesRoute()).toBeNull();
  });
});
