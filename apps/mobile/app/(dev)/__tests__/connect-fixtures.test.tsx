import DevConnectFixturesRoute from '../connect-fixtures';
...
describe('DevConnectFixturesRoute (implementation plan for issue #9, Decision 13 — production gating)', () => {
  ...
  it('returns null when __DEV__ is false, without rendering anything or requiring the panel', () => {
    ...
    expect(DevConnectFixturesRoute()).toBeNull();
  });
});
