...
export const MU_CLASS_MAP: Record<string, MuClassEntry> = {
  ...
  'mu-bars': { status: 'primitive', owners: ['BarChart'] },
  'mu-bars__bar': { status: 'primitive', owners: ['BarChart'] },
  'mu-bars__bar--muted': { status: 'primitive', owners: ['BarChart'] },
  'mu-bars__bar--warm': { status: 'primitive', owners: ['BarChart'] },
  'mu-bars__col': { status: 'primitive', owners: ['BarChart'] },
  'mu-bars__lbl': { status: 'primitive', owners: ['BarChart'] },
  ...
  'mu-donut': { status: 'primitive', owners: ['DonutChart'] },
  ...
  'mu-head__action--brand': { status: 'primitive', owners: ['ScreenHeader'] },
  'mu-head__action--dot': { status: 'primitive', owners: ['ScreenHeader'] },
  ...
  'mu-item': { status: 'primitive', owners: ['ListRow'] },
  'mu-item__chev': { status: 'primitive', owners: ['BankRow', 'ListRow'] },
  'mu-item__icon': { status: 'primitive', owners: ['ListRow'] },
  'mu-item__sub': { status: 'primitive', owners: ['BankRow', 'ListRow'] },
  'mu-item__title': { status: 'primitive', owners: ['ListRow'] },
  'mu-item__txt': { status: 'primitive', owners: ['CategoryRow', 'BankRow', 'ListRow'] },
  ...
  'mu-legend__name': { status: 'primitive', owners: ['Legend'] },
  'mu-legend__row': { status: 'primitive', owners: ['Legend'] },
  'mu-legend__val': { status: 'primitive', owners: ['Legend'] },
  'mu-line': { status: 'primitive', owners: ['LineChart'] },
  'mu-list': { status: 'primitive', owners: ['ListGroup'] },
  ...
  'mu-topbar': { status: 'primitive', owners: ['TopBar'] },
  'mu-topbar__btn': { status: 'primitive', owners: ['TopBar'] },
  'mu-topbar__title': { status: 'primitive', owners: ['TopBar'] },
  'mu-topbar__title--left': { status: 'primitive', owners: ['TopBar'] },
