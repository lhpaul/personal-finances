...
export const MU_CLASS_MAP: Record<string, MuClassEntry> = {
  ...
  'mu-bank': { status: 'deferred', note: 'Deferred to #9 (Connect a bank).' },
  'mu-bank__logo': { status: 'deferred', note: 'Deferred to #9 (Connect a bank).' },
  'mu-bank__name': { status: 'deferred', note: 'Deferred to #9 (Connect a bank).' },
  ...
  'mu-cat-row': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-cat-row__bar': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-cat-row__fill': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-cat-row__icon': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  ...
  'mu-head': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head--plain': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__action': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__action--brand': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__action--dot': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__avatar': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__avatar--brand': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__sub': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__title': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-head__txt': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  ...
  'mu-item__chev': { status: 'deferred', note: 'Deferred to #19 (Settings hub).' },
  'mu-item__icon': { status: 'deferred', note: 'Deferred to #19 (Settings hub).' },
  'mu-item__sub': { status: 'deferred', note: 'Deferred to #19 (Settings hub).' },
  'mu-item__title': { status: 'deferred', note: 'Deferred to #19 (Settings hub).' },
  'mu-item__txt': { status: 'deferred', note: 'Deferred to #19 (Settings hub).' },
  'mu-label': { status: 'primitive', owners: ['Text'] },
  'mu-legend': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-legend__dot': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-legend__name': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-legend__row': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-legend__val': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  'mu-line': { status: 'deferred', note: 'Deferred to #17 (Dashboard charts).' },
  ...
  'mu-topbar': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-topbar__btn': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-topbar__title': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
  'mu-topbar__title--left': { status: 'deferred', note: 'Deferred to #12 (Home) — screen-shell work, out of this item\'s 23-component scope.' },
