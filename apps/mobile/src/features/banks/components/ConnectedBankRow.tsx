 ...
 * ("✓"), not the chevron `BankRow` draws by default — the shipped `BankRow.tsx` already carries
 ...
 * #12 already shipped a trailing slot under another name, use it and add nothing"). No
 * modification to `BankRow.tsx`.
 */
