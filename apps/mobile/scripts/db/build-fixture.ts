  ...
  try {
    ...
    db.insert(transactions)
      .values([
        ...
        // #screen=merchant-edit scenario (implementation plan for issue #14, Seed Data). Three
        // movements already attributed to `mercadolibre`, spanning three consecutive months so
        // the stats card has a non-empty total in each one.
        {
          id: 'seed-movement-mercadolibre-attributed-1',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-attributed-1',
          dedupHash: 'seed-dedup-mercadolibre-attributed-1',
          amount: 74300,
          type: 'debit',
          occurredAt: '2025-11-18T12:00:00.000Z',
          dateLocal: '2025-11-18',
          rawDescription: 'MERCADOLIBRE COMPRA ONLINE PRODUCTO ELECTRONICO',
          merchantId: 'mercadolibre',
          isManual: 0,
          createdAt: ports.now(),
          updatedAt: ports.now(),
        },
        {
          id: 'seed-movement-mercadolibre-attributed-2',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-attributed-2',
          dedupHash: 'seed-dedup-mercadolibre-attributed-2',
          amount: 52100,
          type: 'debit',
          occurredAt: '2025-12-09T12:00:00.000Z',
          dateLocal: '2025-12-09',
          rawDescription: 'MERCADOLIBRE COMPRA ONLINE PRODUCTO ELECTRONICO',
          merchantId: 'mercadolibre',
          isManual: 0,
          createdAt: ports.now(),
        ...
        {
          id: 'seed-movement-mercadolibre-attributed-3',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-attributed-3',
          dedupHash: 'seed-dedup-mercadolibre-attributed-3',
          amount: 24000,
          type: 'debit',
        ...
        // The AC2 witness: hand-categorized as Comida (`category_source = 'user'`) — changing the
        // merchant's default category must leave this row untouched.
        {
          id: 'seed-movement-mercadolibre-user-categorized',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-user-categorized',
          dedupHash: 'seed-dedup-mercadolibre-user-categorized',
          amount: 18990,
          type: 'debit',
          occurredAt: '2026-01-16T12:00:00.000Z',
          dateLocal: '2026-01-16',
          rawDescription: 'MERCADOLIBRE COMPRA ONLINE SUSCRIPCION',
          merchantId: 'mercadolibre',
          transactionCategoryId: 'comida',
          categorySource: 'user',
          isManual: 0,
        ...
        // The candidate the suggestions state must offer: two unattributed movements sharing the
        // same leading token run, `movementCount = 2`.
        {
          id: 'seed-movement-mercadolibre-candidate-1',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-candidate-1',
          dedupHash: 'seed-dedup-mercadolibre-candidate-1',
          amount: 15990,
          type: 'debit',
          occurredAt: '2025-12-20T12:00:00.000Z',
          dateLocal: '2025-12-20',
          rawDescription: 'MERPAGO*MERCADOLIBRE',
          isManual: 0,
          createdAt: ports.now(),
          updatedAt: ports.now(),
        },
        {
          id: 'seed-movement-mercadolibre-candidate-2',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-candidate-2',
          dedupHash: 'seed-dedup-mercadolibre-candidate-2',
          amount: 9990,
          type: 'debit',
        ...
        // The negative control: must never appear as a candidate (Assumption A4) — community
        // suggestions are out of MVP scope.
        {
          id: 'seed-movement-mercadolibre-negative-control',
          userFinancialProductId: checkingId,
          externalId: 'ext-mercadolibre-negative-control',
          dedupHash: 'seed-dedup-mercadolibre-negative-control',
          amount: 12000,
          type: 'debit',
          occurredAt: '2026-01-10T12:00:00.000Z',
          dateLocal: '2026-01-10',
          rawDescription: 'ML CHILE SPA',
          isManual: 0,
          createdAt: ports.now(),
          updatedAt: ports.now(),
        },
