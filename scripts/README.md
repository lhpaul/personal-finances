...
The mockup-vs-app pixel fidelity gate (contract validator, mockup/simulator capture, comparator, `pnpm fidelity*` scripts) lives in **`scripts/mobile-ui/`**. See [`docs/best-practices/stack/mobile-ui-fidelity.md`](../docs/best-practices/stack/mobile-ui-fidelity.md).
