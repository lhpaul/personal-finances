...
| `tsc --noEmit` passes locally but fails in CI because a generated Expo type file is missing | Medium | Medium | Commit `expo-env.d.ts` and keep typed routes off (Decision 8); Step 9 verifies type-check in a clean clone before the PR |
